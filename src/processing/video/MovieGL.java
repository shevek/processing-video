 ...
 * @usage application
 */
public class MovieGL extends PImage implements PConstants {
...
//  NewPrerollListener newPrerollListener;
   ...
   */
  public MovieGL(PApplet parent, String filename) {
    super(0, 0, RGB);
...
//    File file;
    ...
    int w = parent.width;
    int h = parent.height;    
    String caps = "video/x-raw,format=BGRA,width=" + w + ",height=" + h + ",pixel-aspect-ratio=1/1";
    System.out.println(fn);
//    bin = Bin.launch("uridecodebin uri=" + fn + " ! videoconvert ! capsfilter caps=" + caps + " ! videoscale ! glimagesink", true);
//    bin = Bin.launch("filesrc location=" + fn + " ! decodebin ! videoconvert ! capsfilter caps=" + caps, true);
//    bin = Bin.launch("uridecodebin uri=" + fn + " ! videoconvert ! capsfilter caps=" + caps + " ! glupload", true);
    
        
//    pipe = new Pipeline();

    pipe = Pipeline.launch("uridecodebin uri=" + fn + " ! videoconvert ! capsfilter caps=" + caps + " ! videoscale ! glupload name=glup ! appsink name=sink");
...
*/
  ...
  protected void setEventHandlerObject(Object obj) {
    ...
    try {
      movieEventMethod = eventHandler.getClass().getMethod("movieEvent", MovieGL.class);
      return;
    } catch (Exception e) {
